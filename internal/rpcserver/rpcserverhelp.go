...
var helpDescsEnUS = map[string]string{
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in coins (VAR transactions only, 0 for SKA)",
	"getrawmempoolverboseresult-skafee":           "SKA transaction fee in atoms as string (only present for SKA transactions)",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (mond does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown mond.",
	"stop--result0":  "The string 'mond stopping.'",
	...
	"getfeeresult-minrelayfee":               "The minimum relay fee in atoms as string.",
	"getfeeresult-dynamicfeemultiplier":      "The dynamic fee multiplier.",
	"getfeeresult-maxfeerate":                "Maximum allowed fee rate in atoms (100x min for VAR, total emission for SKA).",
	"getfeeresult-fastfee":                   "Fast fee rate in atoms as string.",
	"getfeeresult-normalfee":                 "Normal fee rate in atoms as string.",
	"getfeeresult-slowfee":                   "Slow fee rate in atoms as string.",
