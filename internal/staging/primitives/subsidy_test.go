...
func TestSubsidyCacheCalcs(t *testing.T) {
	...
	tests := []struct {
		...
		wantFull:        3119582664,
		wantWork:        1497399678,
		wantWorkDCP0010: 1247833065,
		wantVote:        187174959,
		wantVoteDCP0010: 311958266,
		wantTrsy:        0,
		wantTrsyDCP0006: 0, // No reduction
	}, {
		...
		wantFull:        3088695706,
		wantWork:        1853217423,
		wantWorkDCP0010: 1544347853,
		wantVote:        185321742,
		wantVoteDCP0010: 308869570,
		wantTrsy:        0,
		wantTrsyDCP0006: 0,
	}, {
		...
		wantFull:        3058114560,
		wantWork:        1834868736,
		wantWorkDCP0010: 1529057280,
		wantVote:        183486873,
		wantVoteDCP0010: 305811456,
		wantTrsy:        0,
		wantTrsyDCP0006: 0,
	}, {
		...
		wantFull:        1896827356,
		wantWork:        1138096413,
		wantWorkDCP0010: 948413678,
		wantVote:        113809641,
		wantVoteDCP0010: 189682735,
		wantTrsy:        0,
		wantTrsyDCP0006: 0,
	}, {
...
func TestTotalSubsidy(t *testing.T) {
	...
	checkTotalSubsidy := func(useDCP0006 bool) {
		...
		const expectedTotalSubsidy = 1906416853963844
...
func TestTotalSubsidyDCP0010(t *testing.T) {
	...
	const expectedTotalSubsidy = 1975194274624580
	if totalSubsidy != expectedTotalSubsidy {
