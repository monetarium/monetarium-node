...
reason, the mond suite has a formalized and rigorous development process which
...
- [Effective Go](https://golang.org/doc/effective_go.html) - The entire mond
...
One of the major design goals of all core mond packages is to aim for complete
...
contributions.  This is how to get your changes into mond.
...
the same license as all of the code in the mond suite.
