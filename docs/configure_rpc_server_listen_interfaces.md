dcrd allows you to bind the RPC server to specific interfaces which enables you
...
|--rpclisten=:9509|all interfaces on port 9509|
|--rpclisten=0.0.0.0:9509|all IPv4 interfaces on port 9509|
|--rpclisten=[::]:9509|all IPv6 interfaces on port 9509|
|--rpclisten=127.0.0.1:9509|only IPv4 localhost on port 9509|
|--rpclisten=[::1]:9509|only IPv6 localhost on port 9509|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:9509|IPv4 localhost on port 8337 and IPv6 localhost on port 9509|
|--rpclisten=:9509 --listen=:8337|all interfaces on ports 9509 and 8337|

The following config file would configure the dcrd RPC server to listen to all interfaces on the default port, including external interfaces, for both IPv4 and IPv6:
