...
"@ | Set-Content -Path $Script:CtlConf -Encoding UTF8
...
function Read-TicketBuyerPrompt {
    ...
    if (-not $Script:TicketsEnabled) { return }
...
"@ | Add-Content -Path $Script:Manifest -Encoding UTF8
    }
