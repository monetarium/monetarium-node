...
require (
	...
	github.com/monetarium/monetarium-node/blockchain/stake v1.3.1 // indirect
	github.com/monetarium/monetarium-node/blockchain/standalone v1.3.1 // indirect
	github.com/monetarium/monetarium-node/chaincfg v1.3.1 // indirect
