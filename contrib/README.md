...
This consists of extra optional tools which may be useful when working with mond
...
- [OpenBSD rc.d](services/rc.d/mond)  
  Provides an example `rc.d` script for configuring mond as a background service
...
- [Service Management Facility](services/smf/mond.xml)  
  Provides an example XML file for configuring mond as a background service on
  illumos.  It also serves as a good starting point for other operating systems
  that use use SMF for service management.

- [systemd](services/systemd/mond.service)  
  Provides an example service file for configuring mond as a background service
